...
func (s *Session) StartExecWinshellRequest(execDto *shared.ExecDto, exe string, args ...string) (*request.Response, error) {
	return s.StartExecRequest(&shared.ExecDto{Executor: "winshell", Exe: exe, Args: args})
}

func (s *Session) StartExecBashRequest(execDto *shared.ExecDto, exe string, args ...string) (*request.Response, error) {
